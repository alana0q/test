...
/**
 * Work around for fullscreen mode in tentel to fix ExtraKeysView not being visible.
...
public class FullScreenWorkAround {
    ...
    public static void apply(tentelActivity activity) {
        new FullScreenWorkAround(activity);
    }

    private FullScreenWorkAround(tentelActivity activity) {
