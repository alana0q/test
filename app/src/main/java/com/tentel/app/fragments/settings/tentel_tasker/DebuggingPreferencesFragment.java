package com.tentel.app.fragments.settings.tentel_tasker;
...
public class DebuggingPreferencesFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        setPreferencesFromResource(R.xml.tentel_tasker_debugging_preferences, rootKey);
    ...
    private void configureLoggingPreferences(@NonNull Context context) {
        ...
        if (logLevelListPreference != null) {
            tentelTaskerAppSharedPreferences preferences = tentelTaskerAppSharedPreferences.build(context, true);
            if (preferences == null) return;

            com.tentel.app.fragments.settings.tentel.DebuggingPreferencesFragment.
